...
export const SidebarWithNavbar = () => (
    <Container>
        {/* <p className="mb-4 mt-3">
            Welcome to the <b>&quot;Tread&quot;</b> Admin Dashboard Theme based on <a href="https://getbootstrap.com" className="text-primary" target="_blank" rel="noopener noreferrer">Bootstrap 4.x</a> version for React called&nbsp;
